                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 profile_details margin_bottom_30">
                        <div class="contact_blog">
                            <div class="contact_inner">
                                <div class="left">
                                    <h3>MSA PRINTING</h3>
                                    <p><strong>Menerima segala jenis cetakan dan menerima upah desain</strong></p>
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-envelope-o"></i> <a href="mailto:Msaprintart@gmail.com">: : Msaprintart@gmail.com</a> </li>
                                        <li><i class="fa fa-phone"></i>: 085391835740</li>
                                        <li><i class="fa fa-map-marker"></i> : Jalan mangga kel. Kampung tengah, kec.sukajadi kota pekanbaru</li>
                                    </ul>
                                </div>
                                <div class="right">
                                    <div class="profile_contacts">
                                        <img class="img-responsive" src="<?= base_url('assets/') ?>MSA.png" alt="#" />
                                    </div>
                                </div>
                                </p>
                            </div>
